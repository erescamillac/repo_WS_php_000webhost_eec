...
{
    // /TX.php?id=99999&pw=12345&un=5&b6=1&b7=0&b8=1
    // CASO: un=5 :: $update_number == 5
    // Caso para Actualizar los CAMPOS [SENT_BOOL_1][SENT_BOOL_2][SENT_BOOL_3]
    // EN el Tuto Original :: provenientes de los Switches en el Circuito {switch1, switch2, switch3}
